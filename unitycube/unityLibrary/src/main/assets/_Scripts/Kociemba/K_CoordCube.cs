...
namespace Kociemba
{
    ...
    public static class CoordCubeTables
    {
        ...
        // Movement
        public static short[,] twist = Tools.DeserializeTable("twist");
        public static short[,] flip = Tools.DeserializeTable("flip");
        public static short[,] FRtoBR = Tools.DeserializeTable("FRtoBR");
        public static short[,] URFtoDLF = Tools.DeserializeTable("URFtoDLF");
        public static short[,] URtoDF = Tools.DeserializeTable("URtoDF");
        public static short[,] URtoUL = Tools.DeserializeTable("URtoUL");
        public static short[,] UBtoDF = Tools.DeserializeTable("UBtoDF");
        public static short[,] MergeURtoULandUBtoDF = Tools.DeserializeTable("MergeURtoULandUBtoDF");        

        //Prune
        public static sbyte[] Slice_URFtoDLF_Parity_Prun = Tools.DeserializeSbyteArray("Slice_URFtoDLF_Parity_Prun");
        public static sbyte[] Slice_URtoDF_Parity_Prun = Tools.DeserializeSbyteArray("Slice_URtoDF_Parity_Prun");
        public static sbyte[] Slice_Twist_Prun = Tools.DeserializeSbyteArray("Slice_Twist_Prun");
        public static sbyte[] Slice_Flip_Prun = Tools.DeserializeSbyteArray("Slice_Flip_Prun");
