...
object AlgUtils {
    ...
    private val ollCaseStates = mapOf(
        ...
        // Dot cases
        "OLL 9" to "BYBYYYYYYYYYYYYYYYY",
        "OLL 10" to "BYBYYYYYYYYYYYYYYYY",
        "OLL 11" to "YYBYYYYYYYYYYYYYYYY",
        "OLL 12" to "YYBYYYBYYYYYYYYYYYY",

        // L shapes
        "OLL 13" to "YYBYYYYYYYYYYYYYYYY",
        "OLL 14" to "BYBYYYYYYYYYYYYYYYY",
        "OLL 15" to "YYBYYYYYYYYYYYYYYYY",
        "OLL 16" to "BYBYYYYYYYYYYYYYYYY",

        // P shapes
        "OLL 17" to "YYYBYYBYYYYYYYYYYYYY",
        "OLL 18" to "BYYBYYBYYYYYYYYYYYYY",
        "OLL 19" to "YYBYYYYYYYYYYYYYYYY",
        "OLL 20" to "BYBYYYYYYYYYYYYYYYY",

        // T shapes
        "OLL 21" to "YYBYYYYYYYYYYYYYYYY",
        "OLL 22" to "BYBYYYYYYYYYYYYYYYY",
        "OLL 23" to "YYBYYYYYYYYYYYYYYYY",
        "OLL 24" to "BYBYYYYYYYYYYYYYYYY",

        // C shapes
        "OLL 25" to "YYBYYYYYYYYYYYYYYYY",
        "OLL 26" to "BYBYYYYYYYYYYYYYYYY",
        "OLL 27" to "YYBYYYYYYYYYYYYYYYY",

        // Corners oriented correctly
        "OLL 28" to "YYYYYYYYYYYYYYYYYYY",
        "OLL 29" to "YYYYYYYYYYYYYYYYYYY",
        "OLL 30" to "YYYYYYYYYYYYYYYYYYY",
        "OLL 31" to "YYYYYYYYYYYYYYYYYYY",
        "OLL 32" to "YYYYYYYYYYYYYYYYYYY",
        "OLL 33" to "YYYYYYYYYYYYYYYYYYY",
        "OLL 34" to "YYYYYYYYYYYYYYYYYYY",
        "OLL 35" to "YYYYYYYYYYYYYYYYYYY",
        "OLL 36" to "YYYYYYYYYYYYYYYYYYY",
        "OLL 37" to "YYYYYYYYYYYYYYYYYYY",
